...
MapD_rel_algebra_execute_args = function(args) {
  this.session = null;
  this.rel_algebra = null;
  this.column_format = null;
  if (args) {
    if (args.session !== undefined && args.session !== null) {
      this.session = args.session;
    }
    if (args.rel_algebra !== undefined && args.rel_algebra !== null) {
      this.rel_algebra = args.rel_algebra;
    }
    if (args.column_format !== undefined && args.column_format !== null) {
      this.column_format = args.column_format;
    }
...
MapD_rel_algebra_execute_args.prototype = {};
MapD_rel_algebra_execute_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.rel_algebra = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
MapD_rel_algebra_execute_args.prototype.write = function(output) {
  output.writeStructBegin('MapD_rel_algebra_execute_args');
  if (this.session !== null && this.session !== undefined) {
    output.writeFieldBegin('session', Thrift.Type.I32, 1);
    output.writeI32(this.session);
    output.writeFieldEnd();
  }
  if (this.rel_algebra !== null && this.rel_algebra !== undefined) {
    output.writeFieldBegin('rel_algebra', Thrift.Type.STRING, 2);
    output.writeString(this.rel_algebra);
    output.writeFieldEnd();
  }
  if (this.column_format !== null && this.column_format !== undefined) {
    output.writeFieldBegin('column_format', Thrift.Type.BOOL, 3);
...
MapD_rel_algebra_execute_result = function(args) {
  this.success = null;
  this.e = null;
  this.te = null;
  if (args instanceof TMapDException) {
...
MapD_rel_algebra_execute_result.prototype = {};
MapD_rel_algebra_execute_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
MapD_rel_algebra_execute_result.prototype.write = function(output) {
  output.writeStructBegin('MapD_rel_algebra_execute_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
MapDClient.prototype.rel_algebra_execute = function(session, rel_algebra, column_format, callback) {
  if (callback === undefined) {
    this.send_rel_algebra_execute(session, rel_algebra, column_format);
    return this.recv_rel_algebra_execute();
  } else {
    var postData = this.send_rel_algebra_execute(session, rel_algebra, column_format, true);
    return this.output.getTransport()
      .jqRequest(this, postData, arguments, this.recv_rel_algebra_execute);
  }
};

MapDClient.prototype.send_rel_algebra_execute = function(session, rel_algebra, column_format, callback) {
  this.output.writeMessageBegin('rel_algebra_execute', Thrift.MessageType.CALL, this.seqid);
  var args = new MapD_rel_algebra_execute_args();
  args.session = session;
  args.rel_algebra = rel_algebra;
  args.column_format = column_format;
  args.write(this.output);
  this.output.writeMessageEnd();
  return this.output.getTransport().flush(callback);
...
MapDClient.prototype.recv_rel_algebra_execute = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  var result = new MapD_rel_algebra_execute_result();
  result.read(this.input);
  this.input.readMessageEnd();
  ...
  throw 'rel_algebra_execute failed: unknown result';
};
MapDClient.prototype.get_row_count = function(session, table_name, callback) {
  if (callback === undefined) {
    this.send_get_row_count(session, table_name);
    return this.recv_get_row_count();
  } else {
    var postData = this.send_get_row_count(session, table_name, true);
    return this.output.getTransport()
      .jqRequest(this, postData, arguments, this.recv_get_row_count);
  }
};

MapDClient.prototype.send_get_row_count = function(session, table_name, callback) {
  this.output.writeMessageBegin('get_row_count', Thrift.MessageType.CALL, this.seqid);
...
MapDClient.prototype.recv_get_row_count = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'get_row_count failed: unknown result';
};
