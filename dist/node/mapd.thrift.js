  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem122 = null;
          elem122 = new ttypes.TColumnType();
          elem122.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem154 = null;
          elem154 = new ttypes.TFrontendView();
          elem154.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem178 = null;
          elem178 = new ttypes.TColumnType();
          elem178.read(input);
