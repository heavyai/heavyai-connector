...
TStringDictKey.prototype[Symbol.for("read")] = function(input) {
...
TStringDictKey.prototype[Symbol.for("write")] = function(output) {
...
TTypeInfo.prototype = {};
TTypeInfo.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        ...
        this.dict_key[Symbol.for("read")](input);
      } else {
        input.skip(ftype);
      }
      break;
...
TTypeInfo.prototype[Symbol.for("write")] = function(output) {
  ...
  if (this.nullable !== null && this.nullable !== undefined) {
    output.writeFieldBegin('nullable', Thrift.Type.BOOL, 3);
    output.writeBool(this.nullable);
    output.writeFieldEnd();
  }
  if (this.is_array !== null && this.is_array !== undefined) {
    output.writeFieldBegin('is_array', Thrift.Type.BOOL, 4);
  ...
  if (this.dict_key !== null && this.dict_key !== undefined) {
    ...
    this.dict_key[Symbol.for("write")](output);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
