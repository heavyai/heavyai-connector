  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem44 = null;
          elem44 = new ttypes.TCountDistinctDescriptor();
          elem44.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem97 = null;
          elem97 = new ttypes.TCountDistinctSet();
          elem97.read(input);
