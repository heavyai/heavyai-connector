...
TDatum = module.exports.TDatum = function(args) {
  this.val = null;
  this.is_null = null;
  if (args) {
...
TTypeInfo = module.exports.TTypeInfo = function(args) {
  this.type = null;
  this.encoding = null;
  this.nullable = null;
  this.is_array = null;
...
TColumnData = module.exports.TColumnData = function(args) {
  this.int_col = null;
  this.real_col = null;
  this.str_col = null;
  this.arr_col = null;
...
TStringRow = module.exports.TStringRow = function(args) {
  this.cols = null;
  if (args) {
    if (args.cols !== undefined && args.cols !== null) {
...
TDBInfo = module.exports.TDBInfo = function(args) {
  this.db_name = null;
  this.db_owner = null;
  if (args) {
...
TMapDException = module.exports.TMapDException = function(args) {
...
ThriftException = module.exports.ThriftException = function(args) {
  Thrift.TException.call(this, "ThriftException")
...
TRenderProperty = module.exports.TRenderProperty = function(args) {
...
TCopyParams = module.exports.TCopyParams = function(args) {
  this.delimiter = null;
  this.null_str = null;
...
TDetectResult = module.exports.TDetectResult = function(args) {
  this.row_set = null;
...
TImportStatus = module.exports.TImportStatus = function(args) {
  this.elapsed = null;
...
TFrontendView = module.exports.TFrontendView = function(args) {
  this.view_name = null;
...
TServerStatus = module.exports.TServerStatus = function(args) {
  this.read_only = null;
  this.version = null;
...
TPixel = module.exports.TPixel = function(args) {
  this.x = null;
  this.y = null;
  if (args) {
...
TPixelRowResult = module.exports.TPixelRowResult = function(args) {
  this.pixel = null;
  this.row_id = null;
  this.row_set = null;
  this.nonce = null;
...
TPixelResult = module.exports.TPixelResult = function(args) {
...
TRenderResult = module.exports.TRenderResult = function(args) {
  this.image = null;
  this.nonce = null;
  this.execution_time_ms = null;
...
TMemorySummary = module.exports.TMemorySummary = function(args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem102 = null;
          elem102 = new ttypes.TGpuMemorySummary();
          elem102.read(input);
