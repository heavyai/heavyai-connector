...
var MapD_clone_session_args = function(args) {
  this.session = null;
  if (args) {
    if (args.session !== undefined && args.session !== null) {
      this.session = args.session;
...
var MapD_clone_session_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof ttypes.TMapDException) {
    this.e = args;
...
MapDClient.prototype.send_clone_session = function(session) {
  var output = new this.pClass(this.output);
...
MapDClient.prototype.recv_clone_session = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
...
MapDClient.prototype.send_interrupt = function(query_session, interrupt_session) {
  var output = new this.pClass(this.output);
...
MapDProcessor.prototype.process_clone_session = function(seqid, input, output) {
  var args = new MapD_clone_session_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.clone_session.length === 1) {
    Q.fcall(this._handler.clone_session, args.session)
      .then(function(result) {
        var result_obj = new MapD_clone_session_result({success: result});
        ...
        var result;
        if (err instanceof ttypes.TMapDException) {
          result = new MapD_clone_session_result(err);
          output.writeMessageBegin("clone_session", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.clone_session(args.session, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof ttypes.TMapDException) {
        result_obj = new MapD_clone_session_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("clone_session", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("clone_session", Thrift.MessageType.EXCEPTION, seqid);
...
MapDProcessor.prototype.process_interrupt = function(seqid, input, output) {
  ...
  if (this._handler.interrupt.length === 2) {
    Q.fcall(this._handler.interrupt, args.query_session, args.interrupt_session)
      .then(function(result) {
