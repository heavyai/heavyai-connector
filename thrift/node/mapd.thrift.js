  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem264 = null;
          elem264 = new ttypes.TServerStatus();
          elem264.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem312 = null;
          elem312 = new ttypes.TNodeMemoryInfo();
          elem312.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem330 = null;
          elem330 = new completion_hints_ttypes.TCompletionHint();
          elem330.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem356 = null;
          elem356 = new ttypes.TFrontendView();
          elem356.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem404 = null;
          elem404 = new ttypes.TColumnType();
          elem404.read(input);
          ...
          for (var _i419 = 0; _i419 < _size414; ++_i419)
          {
            ...
            for (var _i427 = 0; _i427 < _size422; ++_i427)
            {
              ...
              for (var _i435 = 0; _i435 < _size430; ++_i435)
              {
                ...
                {
                  var elem444 = null;
                  elem444 = new ttypes.TRenderDatum();
                  elem444.read(input);
                  val437.push(elem444);
                }
                input.readListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem470 = null;
          elem470 = new ttypes.TColumnType();
          elem470.read(input);
