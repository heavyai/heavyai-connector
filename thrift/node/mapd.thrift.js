  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem138 = null;
          elem138 = new ttypes.TColumnType();
          elem138.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem170 = null;
          elem170 = new ttypes.TFrontendView();
          elem170.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem194 = null;
          elem194 = new ttypes.TColumnType();
          elem194.read(input);
...
MapDClient.prototype.execute_first_step = function(session, query, column_format, nonce, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_execute_first_step(session, query, column_format, nonce);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_execute_first_step(session, query, column_format, nonce);
...
MapDClient.prototype.send_execute_first_step = function(session, query, column_format, nonce) {
  var output = new this.pClass(this.output);
...
MapDClient.prototype.start_query = function(session, query_ra, column_format, nonce, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_start_query(session, query_ra, column_format, nonce);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_start_query(session, query_ra, column_format, nonce);
...
MapDClient.prototype.send_start_query = function(session, query_ra, column_format, nonce) {
  var output = new this.pClass(this.output);
...
MapDProcessor.prototype.process_execute_first_step = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.execute_first_step.length === 4) {
    Q.fcall(this._handler.execute_first_step, args.session, args.query, args.column_format, args.nonce)
      .then(function(result) {
    ...
    this._handler.execute_first_step(args.session, args.query, args.column_format, args.nonce, function (err, result) {
      if (err == null || err instanceof ttypes.TMapDException || err instanceof ttypes.ThriftException) {
...
MapDProcessor.prototype.process_start_query = function(seqid, input, output) {
  ...
  if (this._handler.start_query.length === 4) {
    Q.fcall(this._handler.start_query, args.session, args.query_ra, args.column_format, args.nonce)
      .then(function(result) {
    ...
    this._handler.start_query(args.session, args.query_ra, args.column_format, args.nonce, function (err, result) {
      if (err == null || err instanceof ttypes.TMapDException || err instanceof ttypes.ThriftException) {
