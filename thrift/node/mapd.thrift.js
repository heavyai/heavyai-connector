  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem396 = null;
          elem396 = new ttypes.TFrontendView();
          elem396.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem444 = null;
          elem444 = new ttypes.TDashboardGrantees();
          elem444.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem484 = null;
          elem484 = new ttypes.TColumnType();
          elem484.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem500 = null;
          elem500 = new ttypes.TGeoFileLayerInfo();
          elem500.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem508 = null;
          elem508 = new ttypes.TColumnType();
          elem508.read(input);
          ...
          for (var _i523 = 0; _i523 < _size518; ++_i523)
          {
            ...
            for (var _i531 = 0; _i531 < _size526; ++_i531)
            {
              ...
              for (var _i539 = 0; _i539 < _size534; ++_i539)
              {
                ...
                {
                  var elem548 = null;
                  elem548 = new ttypes.TRenderDatum();
                  elem548.read(input);
                  val541.push(elem548);
                }
                input.readListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem574 = null;
          elem574 = new ttypes.TColumnType();
          elem574.read(input);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i623 = 0; _i623 < _size618; ++_i623)
        {
          var key624 = null;
          var val625 = null;
          key624 = input.readString();
          val625 = input.readString();
