  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem412 = null;
          elem412 = new ttypes.TColumnType();
          elem412.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem420 = null;
          elem420 = new ttypes.TColumnType();
          elem420.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem428 = null;
          elem428 = new ttypes.TColumnType();
          elem428.read(input);
          ...
          for (var _i443 = 0; _i443 < _size438; ++_i443)
          {
            ...
            for (var _i451 = 0; _i451 < _size446; ++_i451)
            {
              ...
              for (var _i459 = 0; _i459 < _size454; ++_i459)
              {
                ...
                {
                  var elem468 = null;
                  elem468 = new ttypes.TRenderDatum();
                  elem468.read(input);
                  val461.push(elem468);
                }
                input.readListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem494 = null;
          elem494 = new ttypes.TColumnType();
          elem494.read(input);
