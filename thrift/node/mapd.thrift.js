  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem288 = null;
          elem288 = new ttypes.TServerStatus();
          elem288.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem344 = null;
          elem344 = new ttypes.TNodeMemoryInfo();
          elem344.read(input);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i351 = 0; _i351 < _size346; ++_i351)
        {
          var key352 = null;
          var val353 = null;
          key352 = input.readString();
          val353 = new ttypes.TColumnType();
          val353.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem362 = null;
          elem362 = new completion_hints_ttypes.TCompletionHint();
          elem362.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem388 = null;
          elem388 = new ttypes.TFrontendView();
          elem388.read(input);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i555 = 0; _i555 < _size550; ++_i555)
        {
          var key556 = null;
          var val557 = null;
          key556 = input.readString();
          val557 = new ttypes.TColumnType();
          val557.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem566 = null;
          elem566 = new ttypes.TColumnType();
          elem566.read(input);
