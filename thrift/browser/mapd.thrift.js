...
MapDClient.prototype.connect = function(user, passwd, dbname) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_connect(user, passwd, dbname, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.disconnect = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_disconnect(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_server_status = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_server_status(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_status = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_status(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_hardware_info = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_hardware_info(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_tables = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_tables(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_physical_tables = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_physical_tables(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_views = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_views(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_tables_meta = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_tables_meta(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_table_details = function(session, table_name) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_table_details(session, table_name, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_internal_table_details = function(session, table_name) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_internal_table_details(session, table_name, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_users = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_users(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_databases = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_databases(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_version = function() {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_version(function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.start_heap_profile = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_start_heap_profile(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.stop_heap_profile = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_stop_heap_profile(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_heap_profile = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_heap_profile(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_memory = function(session, memory_level) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_memory(session, memory_level, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.clear_cpu_memory = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_clear_cpu_memory(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.clear_gpu_memory = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_clear_gpu_memory(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.set_table_epoch = function(session, db_id, table_id, new_epoch) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_set_table_epoch(session, db_id, table_id, new_epoch, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.set_table_epoch_by_name = function(session, table_name, new_epoch) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_set_table_epoch_by_name(session, table_name, new_epoch, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_table_epoch = function(session, db_id, table_id) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_table_epoch(session, db_id, table_id, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_table_epoch_by_name = function(session, table_name) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_table_epoch_by_name(session, table_name, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.sql_execute = function(session, query, column_format, nonce, first_n, at_most_n) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_sql_execute(session, query, column_format, nonce, first_n, at_most_n, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.sql_execute_df = function(session, query, device_type, device_id, first_n) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_sql_execute_df(session, query, device_type, device_id, first_n, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.sql_execute_gdf = function(session, query, device_id, first_n) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_sql_execute_gdf(session, query, device_id, first_n, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.deallocate_df = function(session, df, device_type, device_id) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_deallocate_df(session, df, device_type, device_id, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.interrupt = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_interrupt(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.sql_validate = function(session, query) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_sql_validate(session, query, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_completion_hints = function(session, sql, cursor) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_completion_hints(session, sql, cursor, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.set_execution_mode = function(session, mode) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_set_execution_mode(session, mode, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.render_vega = function(session, widget_id, vega_json, compression_level, nonce) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_render_vega(session, widget_id, vega_json, compression_level, nonce, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_result_row_for_pixel = function(session, widget_id, pixel, table_col_names, column_format, pixelRadius, nonce) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_result_row_for_pixel(session, widget_id, pixel, table_col_names, column_format, pixelRadius, nonce, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_frontend_view = function(session, view_name) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_frontend_view(session, view_name, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.send_get_frontend_view = function(session, view_name, callback) {
  ...
  var args = new MapD_get_frontend_view_args(params);
  try {
...
MapDClient.prototype.get_frontend_views = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_frontend_views(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.send_get_frontend_views = function(session, callback) {
  ...
  var args = new MapD_get_frontend_views_args(params);
  try {
...
MapDClient.prototype.create_frontend_view = function(session, view_name, view_state, image_hash, view_metadata) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_create_frontend_view(session, view_name, view_state, image_hash, view_metadata, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.send_create_frontend_view = function(session, view_name, view_state, image_hash, view_metadata, callback) {
  ...
  var args = new MapD_create_frontend_view_args(params);
  try {
...
MapDClient.prototype.delete_frontend_view = function(session, view_name) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_delete_frontend_view(session, view_name, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.send_delete_frontend_view = function(session, view_name, callback) {
  ...
  var args = new MapD_delete_frontend_view_args(params);
  try {
...
MapDClient.prototype.get_dashboard = function(session, dashboard_id) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_dashboard(session, dashboard_id, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_dashboards = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_dashboards(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.create_dashboard = function(session, dashboard_name, dashboard_state, image_hash, dashboard_metadata) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_create_dashboard(session, dashboard_name, dashboard_state, image_hash, dashboard_metadata, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.replace_dashboard = function(session, dashboard_id, dashboard_name, dashboard_owner, dashboard_state, image_hash, dashboard_metadata) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_replace_dashboard(session, dashboard_id, dashboard_name, dashboard_owner, dashboard_state, image_hash, dashboard_metadata, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.delete_dashboard = function(session, dashboard_id) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_delete_dashboard(session, dashboard_id, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.share_dashboard = function(session, dashboard_id, groups, objects, permissions) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_share_dashboard(session, dashboard_id, groups, objects, permissions, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.unshare_dashboard = function(session, dashboard_id, groups, objects, permissions) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_unshare_dashboard(session, dashboard_id, groups, objects, permissions, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_dashboard_grantees = function(session, dashboard_id) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_dashboard_grantees(session, dashboard_id, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_link_view = function(session, link) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_link_view(session, link, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.create_link = function(session, view_state, view_metadata) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_create_link(session, view_state, view_metadata, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.load_table_binary = function(session, table_name, rows) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_load_table_binary(session, table_name, rows, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.load_table_binary_columnar = function(session, table_name, cols) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_load_table_binary_columnar(session, table_name, cols, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.load_table_binary_arrow = function(session, table_name, arrow_stream) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_load_table_binary_arrow(session, table_name, arrow_stream, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.load_table = function(session, table_name, rows) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_load_table(session, table_name, rows, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.detect_column_types = function(session, file_name, copy_params) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_detect_column_types(session, file_name, copy_params, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.create_table = function(session, table_name, row_desc, table_type, create_params) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_create_table(session, table_name, row_desc, table_type, create_params, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.import_table = function(session, table_name, file_name, copy_params) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_import_table(session, table_name, file_name, copy_params, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.import_geo_table = function(session, table_name, file_name, copy_params, row_desc) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_import_geo_table(session, table_name, file_name, copy_params, row_desc, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.import_table_status = function(session, import_id) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_import_table_status(session, import_id, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_first_geo_file_in_archive = function(session, archive_path, copy_params) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_first_geo_file_in_archive(session, archive_path, copy_params, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_all_files_in_archive = function(session, archive_path, copy_params) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_all_files_in_archive(session, archive_path, copy_params, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.start_query = function(session, query_ra, just_explain) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_start_query(session, query_ra, just_explain, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.execute_first_step = function(pending_query) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_execute_first_step(pending_query, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.send_execute_first_step = function(pending_query, callback) {
  ...
  var args = new MapD_execute_first_step_args(params);
  try {
...
MapDClient.prototype.broadcast_serialized_rows = function(serialized_rows, row_desc, query_id) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_broadcast_serialized_rows(serialized_rows, row_desc, query_id, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.start_render_query = function(session, widget_id, node_idx, vega_json) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_start_render_query(session, widget_id, node_idx, vega_json, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.execute_next_render_step = function(pending_render, merged_data) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_execute_next_render_step(pending_render, merged_data, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.insert_data = function(session, insert_data) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_insert_data(session, insert_data, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.checkpoint = function(session, db_id, table_id) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_checkpoint(session, db_id, table_id, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_table_descriptor = function(session, table_name) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_table_descriptor(session, table_name, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.send_get_table_descriptor = function(session, table_name, callback) {
  ...
  var args = new MapD_get_table_descriptor_args(params);
  try {
...
MapDClient.prototype.get_row_descriptor = function(session, table_name) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_row_descriptor(session, table_name, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.send_get_row_descriptor = function(session, table_name, callback) {
  ...
  var args = new MapD_get_row_descriptor_args(params);
  try {
...
MapDClient.prototype.get_roles = function(session) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_roles(session, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_db_objects_for_grantee = function(session, roleName) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_db_objects_for_grantee(session, roleName, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_db_object_privs = function(session, objectName, type) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_db_object_privs(session, objectName, type, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_all_roles_for_user = function(session, userName) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_all_roles_for_user(session, userName, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.set_license_key = function(session, key, nonce) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_set_license_key(session, key, nonce, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
...
MapDClient.prototype.get_license_claims = function(session, nonce) {
  var self = this;
  return new Promise(function(resolve, reject) {
    self.send_get_license_claims(session, nonce, function(error, result) {
      if (error) {
        reject(error);
      } else {
        resolve(result);
