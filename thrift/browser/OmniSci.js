    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i289 = 0; _i289 < _size287; ++_i289) {
          var elem290 = null;
          elem290 = input.readString().value;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i309 = 0; _i309 < _size307; ++_i309) {
          var elem310 = null;
          elem310 = new TDashboardGrantees();
          elem310.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i412 = 0; _i412 < _size410; ++_i412) {
          ...
          var key413 = null;
          var val414 = null;
          key413 = input.readString().value;
          val414 = input.readString().value;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i419 = 0; _i419 < _size417; ++_i419) {
          var elem420 = null;
          elem420 = new TUserDefinedFunction();
          elem420.read(input);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i423 = 0; _i423 < _size421; ++_i423) {
          var elem424 = null;
          elem424 = new TUserDefinedTableFunction();
          elem424.read(input);
