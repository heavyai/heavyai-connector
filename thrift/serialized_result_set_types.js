...
TSlotSize.prototype = {};
TSlotSize.prototype[Symbol.for("read")] = function(input) {
...
TSlotSize.prototype[Symbol.for("write")] = function(output) {
...
TColSlotContext.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TColSlotContext.prototype[Symbol.for("write")] = function(output) {
  ...
  if (this.slot_sizes !== null && this.slot_sizes !== undefined) {
    ...
    for (var iter12 in this.slot_sizes) {
      if (this.slot_sizes.hasOwnProperty(iter12)) {
        ...
        iter12[Symbol.for("write")](output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
TCountDistinctDescriptor.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TCountDistinctDescriptor.prototype[Symbol.for("write")] = function(output) {
...
TResultSetBufferDescriptor = function(args) {
  ...
  if (args) {
    ...
    if (args.gpu_shared_mem_used !== undefined && args.gpu_shared_mem_used !== null) {
      this.gpu_shared_mem_used = args.gpu_shared_mem_used;
    }
  }
};
TResultSetBufferDescriptor.prototype = {};
TResultSetBufferDescriptor.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        ...
        this.col_slot_context[Symbol.for("read")](input);
      } else {
        input.skip(ftype);
      }
      break;
...
TResultSetBufferDescriptor.prototype[Symbol.for("write")] = function(output) {
  ...
  if (this.col_slot_context !== null && this.col_slot_context !== undefined) {
    ...
    this.col_slot_context[Symbol.for("write")](output);
    output.writeFieldEnd();
  }
  ...
  if (this.gpu_shared_mem_used !== null && this.gpu_shared_mem_used !== undefined) {
    output.writeFieldBegin('gpu_shared_mem_used', Thrift.Type.BOOL, 14);
    output.writeBool(this.gpu_shared_mem_used);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
TTargetInfo.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        ...
        this.type[Symbol.for("read")](input);
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.STRUCT) {
        ...
        this.arg_type[Symbol.for("read")](input);
      } else {
        input.skip(ftype);
      }
      break;
...
TTargetInfo.prototype[Symbol.for("write")] = function(output) {
...
TCountDistinctSetStorage.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TCountDistinctSetStorage.prototype[Symbol.for("write")] = function(output) {
...
TCountDistinctSet.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        ...
        this.storage[Symbol.for("read")](input);
      } else {
        input.skip(ftype);
      }
      break;
...
TCountDistinctSet.prototype[Symbol.for("write")] = function(output) {
  ...
  if (this.storage !== null && this.storage !== undefined) {
    ...
    this.storage[Symbol.for("write")](output);
    output.writeFieldEnd();
  }
...
TSerializedRows.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        ...
        this.descriptor[Symbol.for("read")](input);
      } else {
        input.skip(ftype);
      }
      break;
...
TSerializedRows.prototype[Symbol.for("write")] = function(output) {
  ...
  if (this.descriptor !== null && this.descriptor !== undefined) {
    ...
    this.descriptor[Symbol.for("write")](output);
    output.writeFieldEnd();
  }
  if (this.targets !== null && this.targets !== undefined) {
    ...
    for (var iter61 in this.targets) {
      if (this.targets.hasOwnProperty(iter61)) {
        ...
        iter61[Symbol.for("write")](output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  if (this.count_distinct_sets !== null && this.count_distinct_sets !== undefined) {
    ...
    for (var iter64 in this.count_distinct_sets) {
      if (this.count_distinct_sets.hasOwnProperty(iter64)) {
        ...
        iter64[Symbol.for("write")](output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
